...
create_submission <- function(y_pred_test, name){
  ...
  filename <- paste(name, "../data/submission.csv", sep = "_")
  submission <- read.csv("../data/submission_format.csv")
...
set.seed(123)
# Leemos los datos
train_x <- read.csv('../data/train_values.csv')
train_y <- read.csv('../data/train_labels.csv')
test_x <- read.csv('../data/test_values.csv')
